...
import com.sunshine.utils.common.ReflectionUtils;
...
public class ImportExcel {
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						val = this.getValue(val.toString(), ef.dictType(), "");
	...
	private Object getValue(String value, String dictType, String defaultValue) {
